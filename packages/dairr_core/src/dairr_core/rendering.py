"""Article parsing and HTML rendering independent of the host shell.

The parsing helpers live here rather than in :mod:`article` to avoid a
circular dependency: saving an article needs its HTML rendering.
"""
